...
// `this` is reference to the object that was created when it was instantiated. It is reading off all of the properties in the Student constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
// `this` in this case is reading the whole document of the website. `this` is iterating all of the factors that were contributed to create the window.
// 3. Explain why "this" is different when an arrow function is used.
// From my understanding arrow cannot carry value call `this` and `this` can only be used when it is in original constructor format.
